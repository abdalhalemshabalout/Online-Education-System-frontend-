  ...
  implements OnInit
{
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.showNotification(
          'snackbar-success',
          'Yeni Bölüm Kaydı Başarıyla Eklendi...!!!',
          'bottom',
          'center'
        );
      }
  ...
  editCall(row) {
    // this.getAcademicianByDepartmentId({ 'departmentId': row.id });
    // console.log(this.deparmentAcademician);
    // console.log(row.id);
    this.id = row.id;
    let tempDirection;
    if (localStorage.getItem('isRtl') === 'true') {
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.showNotification(
          'black',
          'Bölüm Bilgileri Başarıyla Güncellendi...!!!',
          'bottom',
          'center'
        );
      }
  ...
  removeSelectedRows() {
    ...
    this.showNotification(
      'snackbar-danger',
      totalSelect + 'Bölüm Silindi...!!!',
      'bottom',
      'center'
    );
  }
  public loadData() {
    this.exampleDatabase = new DepartmentService(this.httpClient,this.snackBar);
